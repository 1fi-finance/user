      ...
      >
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(168.27deg, #8c27fc 0%, #4f12ad 100%)",
            }}
          />
          ...
          <button className="absolute bottom-4 left-6 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 flex items-center gap-2">
            <span className="text-sm font-medium" style={{ color: "#f8f5ff" }}>
              Explore now
            </span>
            <svg
              className="w-4 h-4"
        ...
        <div className="px-5 mt-8">
          <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
            <button
              onClick={() =>
                setExpandedSection(expandedSection === "how" ? null : "how")
              }
            ...
            {expandedSection === "how" && (
              <div className="mt-4 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-[#404040] pt-1">
        ...
        <div className="px-5 pb-8 mt-4">
          <button
            className="w-full h-14 rounded-full text-white font-semibold text-base flex items-center justify-center gap-3 transition-transform hover:scale-[1.02] active:scale-[0.98]"
        ...
        <div className="px-5 pb-8 text-center">
          <p className="text-xs text-gray-400">Session active · © 2025 1fi</p>
        </div>
      </main>
    </div>
  );
