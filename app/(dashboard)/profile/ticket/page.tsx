  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Raise a Ticket</h1>
          <p className="text-gray-500 mt-1">We're here to help. Submit your query</p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Fill in the details below and we'll get back to you within 1 hour.
              </DialogDescription>
            </DialogHeader>
        ...
        <Card className="border-gray-100 shadow-sm">
          <CardContent className="p-4 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">support@bachat.app</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-gray-100 shadow-sm">
        <CardHeader className="pb-4">
          <CardTitle className="text-lg font-semibold text-gray-900">Your Tickets</CardTitle>
        </CardHeader>
        <CardContent>
          {tickets.length > 0 ? (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">{ticket.lastMessage}</p>
