...
export default function InvitePage() {
  ...
  const referralCode = 'BACHAT2026'
  const referralLink = 'https://bachat.app/invite/BACHAT2026'
  ...
  const rewards = [
    ...
    { referrals: 10, reward: '₹7,000', description: 'VIP access + priority support' },
    { referrals: 25, reward: '₹20,000', description: 'Dedicated relationship manager' },
  ]
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      {/* Page Header */}
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Invite Friends</h1>
        <p className="text-gray-500 mt-1">Share the app and earn ₹500 for every friend</p>
      </div>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-purple-100 text-sm mt-2">Share this code or link to earn rewards</p>
            </div>
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    <Badge className="bg-[#712CDC] text-white">{tier.referrals} Friends</Badge>
                  </div>
                  <p className="text-sm text-gray-600 mt-1">{tier.description}</p>
                </div>
                <div className="text-right">
                  <p className="text-xl font-bold text-[#712CDC]">{tier.reward}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <Card className="border-gray-100 shadow-sm bg-gray-50">
        <CardContent className="p-6">
          <p className="text-sm text-gray-600">
            <strong>Terms & Conditions:</strong> Rewards are credited after your referred friend completes 
            their account verification. Maximum reward per friend is ₹500. For more details, 
