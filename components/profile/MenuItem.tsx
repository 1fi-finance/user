...
export default function MenuItem({ icon, title, subtitle, onClick, href }: MenuItemProps) {
  ...
  return (
    ...
    >
      {/* Icon container */}
      <div className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#f8f5ff' }}>
        <div className="text-[#712CDC]">
          {icon}
        </div>
      </div>
