...
export default function RaiseTicketModal({ isOpen, onClose, onSubmit }: RaiseTicketModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50">
      <div className="w-full max-w-md bg-white rounded-t-3xl overflow-hidden animate-slide-up" style={{ borderTopLeftRadius: '16px', borderTopRightRadius: '16px' }}>
        {step === 'form' ? (
          <>
            {/* Header */}
            <div className="flex items-center justify-between px-5 py-4">
              <h2 className="text-xl font-medium text-gray-900">Raise Ticket</h2>
              <button
                onClick={handleClose}
          ...
          <>
            {/* Success State */}
            <div className="flex flex-col px-8 pt-8 pb-4" style={{ backgroundColor: '#f9fafb' }}>
              {/* Close Button */}
              ...
              <div className="flex justify-center mb-6">
                <div className="w-30 h-30 rounded-full bg-green-100 flex items-center justify-center" style={{ width: '122px', height: '122px' }}>
              ...
              {/* Ticket Number */}
              <div className="flex justify-between items-center px-4 py-3 bg-white rounded-lg mb-4" style={{ border: '1px solid #e6e6e6' }}>
